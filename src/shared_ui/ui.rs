//! Level UI chrome: hint boxes and the tutorial modal, the controls and
//! settings dialogs, victory/defeat overlays, the objective banner, lighting,
//! input-device detection and cursor grab.

use bevy::prelude::*;
use bevy::window::{CursorGrabMode, PrimaryWindow};

use super::camera::MouseSettings;
...
/// Present while a level captures the keyboard as text input (the password
/// prompt). Global hotkey handlers (C/E dialogs, H/T hints) gate on its
/// absence so typed characters don't trigger them. Swept on menu return.
#[derive(Resource)]
